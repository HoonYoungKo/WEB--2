      ...
      <h1 class="my-4 wow fadeInUp"  data-wow-delay="0.3s" style="font-family: 'Gaegu', cursive;"><strong style="color:#6bbadb;">COWALLKER</strong>
		...
		<div class="row">
			<table class="table table-striped" style="text-align:center; border: 1px solid #dddddd; font-family: 'Gaegu', cursive; font-size:18px;" >
				<thead>
					<tr>
						...
						<th style="background-color: #6bbadb; text-align:center;">제목</th>
						<th style="background-color: #6bbadb; text-align:center;">작성자</th>
						<th style="background-color: #6bbadb; text-align:center;">작성일</th>
					</tr>
				</thead>
				<tbody>
					<%
			...
			<%
				if(pageNumber != 1){
			%>
				<a href="bbs.jsp?pageNumber=<%=pageNumber -1%>" class="btn btn-success btn-arrow-left" style="font-family: 'Gaegu', cursive;">이전</a>
			<%
				} if(bbsDAO.nextPage(pageNumber + 1)){
			%>
				<a href="bbs.jsp?pageNumber=<%=pageNumber +1%>" class="btn btn-success btn-arrow-left" style="font-family: 'Gaegu', cursive;">다음</a>
			<%
				}
			%>
			<a href="write.jsp" class="btn btn-primary pull-right" style="margin-left:10px; font-family: 'Gaegu', cursive;">글쓰기</a>
		</div>
	</div>
